...
st.set_page_config(page_title="RenataBot", page_icon="🤖", layout="centered")
...
with st.sidebar:
    ...
    if st.button("🎤 Falar pelo microfone"):
        ...
        #Validacao para verificar se reconheceu a fala
        if texto_ouvido:
            st.success(f"O texto foi reconhecido: {texto_ouvido}")
        
            #Adicionar a msg do uduario no chat
